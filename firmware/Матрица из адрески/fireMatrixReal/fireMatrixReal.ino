...
// настройки пламени
#define FIRE_SCALE 5   // масштаб огня
...
#define SMOOTH_K 20   // коэффициент плавности огня
...
microLED matrix(leds, LED_PIN, M_WIDTH, M_HEIGHT, ZIGZAG, LEFT_BOTTOM, DIR_UP);  // объект матрица
